...
--
DROP TABLE IF EXISTS public.items_variants;
CREATE TABLE IF NOT EXISTS public.items_variants (
  ...
  variant_id INT NOT NULL REFERENCES public.items(id) ON DELETE CASCADE
);
